...
export function getKeys(obj: Record<string, unknown> | null | undefined): string[] | undefined {
  return obj ? Object.keys(obj) : undefined;
}

export function getValues(obj: Record<string, unknown> | null | undefined): unknown[] | undefined {
